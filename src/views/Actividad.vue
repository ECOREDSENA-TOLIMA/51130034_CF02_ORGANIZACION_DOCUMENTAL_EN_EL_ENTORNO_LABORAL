  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9(data-aos="fade-left")
        .titulo-segundo
          h2 Validación documental
        p.mb-4 Apropiar los concomimientos documentales dentro de una organización, incentivando al actuar del quehacer laboral del individuo.
